...
class ViewerBase(ABC):
    ...
    def _log_gaussian_shapes(self, state: newton.State):
        ...
        for gname, gaussian, parent, shape_xform, world_idx, _flags, _is_static in self._gaussian_instances:
            ...
            visible = self.show_gaussians and self._should_render_world(world_idx) and not layer_hidden
            if not visible:
